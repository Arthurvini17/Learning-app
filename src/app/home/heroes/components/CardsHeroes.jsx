...
export default function CardsHeroes({
    ...
    return (
        <div className="md:flex-col md:flex md:items-center md:justify-center md:text-center items-center flex flex-col p-2   bg-white shadow rounded-xl md:p-5 md:gap-5 md:h-[400px]  ">
            <Image src={imageSrc}
                alt={imageAlt}
                width={imageWidth}
                height={imageHeight}
